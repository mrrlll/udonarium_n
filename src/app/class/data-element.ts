...
export class DataElement extends ObjectNode {
  ...
  public static create(name: string, value: number | string = '', attributes: Attributes = {},check: number | string = 0, identifier: string = ''): DataElement {
